        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="text-gray-800 space-y-6 lg:space-y-8 order-2 lg:order-1">
            ...
            <p className="text-sm sm:text-base lg:text-lg leading-relaxed max-w-lg text-gray-700">
              Connect your business to global markets with Global Wheelz
              comprehensive international logistics services. From air freight
              to sea freight, custom clearance to door-to-door delivery, we
              provide seamless logistics solutions that break down barriers and
              expand your reach worldwide.
            </p>

            <a href="/contact">
              <Button className="cursor-pointer" label="Get Quote Now" />
            </a>
          </div>
          ...
          <div className="text-gray-800 space-y-6 lg:space-y-8 order-1 lg:order-2">
            <img
              src="https://png.pngtree.com/png-vector/20220610/ourmid/pngtree-vector-car-tire-and-alloy-wheel-isolated-on-white-background-png-image_4828830.png"
              className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 border-red-300 rounded-full flex items-center justify-center animate-spin"
            />
            ...
            <blockquote className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-light leading-relaxed text-gray-700">
              ...
              —Global Wheelz delivers logistics excellence for all."
            </blockquote>
